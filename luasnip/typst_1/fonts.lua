...
return {
  ...
  s({
    ...
    wordTrig = true,
  }, fmta("*<>*<>", { i(1), i(0) }), { condition = function() return in_typst() and not_in_math() end }),

  s({
    trig = "tit",
    snippetType = "autosnippet",
    wordTrig = true,
  }, fmta("_<>_<>", { i(1), i(0) }), { condition = function() return in_typst() and not_in_math() end }),
  ...
  s({
    ...
    snippetType = "autosnippet",
    wordTrig = true,
  }, fmta("text(red, <>) <>", { i(1), i(0) }), { condition = function() return in_typst() and not_in_math() end }),

  s({
    trig = "blue", 
    snippetType = "autosnippet",
    wordTrig = true,
  }, fmta("text(blue, <>) <>", { i(1), i(0) }), { condition = function() return in_typst() and not_in_math() end }),

  s({
    trig = "green",
    snippetType = "autosnippet", 
    wordTrig = true,
  }, fmta("text(green, <>) <>", { i(1), i(0) }), { condition = function() return in_typst() and not_in_math() end }),

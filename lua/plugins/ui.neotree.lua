return {
  ...
  dependencies = {
    ...
    { "3rd/image.nvim", lazy = true, build = true, enabled = not vim.g.started_with_firenvim and not vim.g.neovide }, -- Optional image support in preview window: See `# Preview Mode` for more information
  },
  keys = {
    {
      "g[",
